    ...
    return function (t) {
        ...
        var n = o(8), e = o(9), s = o(0), r = o(2), c = o(1), a = o(4), u = o(5), l = o(6), f = o(3), p = function () {
            ...
            return Object.defineProperty(t, "defaultOptions", {
                ...
                t.instances = [], s.default.select(".growl-notification").each(function (t) {
                ...
                var t = this;
                this.notification.removeClass("animation-" + this.options.animation.open).addClass("animation-" + this.options.animation.close).addClass("growl-notification--closed"), setTimeout(function () {
